...
class ShareJourneyTestFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    {
        return [
            'sharing-journey:1' => new JourneyDefinition(6, 'Wobble', '19:00', 'Home', '20:00', 'to-home', [
                'sharing-journey:1/stage:1'=> new PublicStageDefinition(1, 'bus-or-coach', Distance::miles("28"), 35, 2, 1, 350, 'standard-ticket', 1),
